...
infosoftglobal.FusionCharts.prototype = {
    ...
    getSWFHTML: function() {
        var swfNode = "";
        var width = this.getAttribute('width').replace('%25','%');
        var height = this.getAttribute('height').replace('%25','%');

        if (navigator.plugins && navigator.mimeTypes && navigator.mimeTypes.length) {
            // netscape plugin architecture
            swfNode = '<embed type="application/x-shockwave-flash" src="'+ this.getAttribute('swf') +'" width="'+ width +'" height="'+ height +'"  ';
            ...
            swfNode = '<object id="'+ this.getAttribute('id') +'" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="'+ width +'" height="'+ height +'">';
